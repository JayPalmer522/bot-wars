...
=== ORDERS LISTS ===
Orders Lists define the sequence of commands individual Bots in your army will attempt during their combat. Examples include:
• Move Forward 3
...
• 0025. 'Name of Bot' is a required field. If you save a Bot with the same name, you overwrite the old version. It is recommended that you devise a Bot Naming System which identifies each Bot to you. 
...
• 0027. 'Select Bot Engine' defines how much Power your Bot's engine can generate. Too little PO may reduce movement and limit Bot targeting scanners and weapons. The smallest and the largest are:
...
• 0029. 'Select Frame Armor' is extra armor added to the natural armor of the frame. The smallest and the largest are:
...
• 0033: 'Select Targeting Map:


• 0033: 'Select Orders List:

• 0033: Select Bot Image:

'BI' stands for Bot Image, so you can identify this selection when you install it. In this version, these are simple placeholder graphic files, just to make sure it works. 
VERSION 2: In Version 2, these simple images will be updated.  
